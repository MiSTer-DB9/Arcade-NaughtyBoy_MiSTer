...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-NaughtyBoy_MiSTer.git"
CORE_NAME=(NaughtyBoy)
...
UPSTREAM_CORE_NAME=(NaughtyBoy)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-NaughtyBoy.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-NaughtyBoy.rbf)
